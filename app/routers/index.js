...
router.patch('/product/:id/update', controller.UpdateProduct);                // modifie un article grâce à son id et depuis un JSON
router.delete('/product/:id/delete', controller.DeleteProduct);               // supprime un article grâce grâce son id
